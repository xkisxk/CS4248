...
class LSTMModel(FairseqEncoderDecoderModel):
    ...
    def build_model(cls, args, task):
        ...
        if args.share_all_embeddings:
            ...
            if task.source_dictionary != task.target_dictionary:
                raise ValueError(f"--share-all-embeddings requires a joint dictionary, source={task.source_dictionary}, target={task.target_dictionary}")
    ...
    def forward(
        ...
        # print("Encoder Embedding:", encoder_out.shape, encoder_out)
        decoder_out = self.decoder(
            prev_output_tokens,
            encoder_out=encoder_out,
            incremental_state=incremental_state,
        )
        # print("Decoder Embedding:", decoder_out.shape, decoder_out)
        return decoder_out

...
set DATAROOT=%ROOT%\data\NIST\strokenet_data
...
set LANG_PAIRS="zh-en"
set EVAL_LANG_PAIRS="zh-en,"
set SAMP_MAIN='"main:zh-en":0.0'
set SAMPLE_WEIGHTS="{\"main:zh-en\": 1.0}" --virtual-data-size 4991980
...
@REM set SAMPLE_WEIGHTS="{\"main:tz-en\": 1.0}" --virtual-data-size 4991980
...
set TASK=translation_multi_simple_epoch_eval --prime-src zh --prime-tgt en
